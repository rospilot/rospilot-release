...
## rospilot (melodic) - 1.5.6-0

The packages in the `rospilot` repository were released into the `melodic` distro by running `/usr/bin/bloom-release rospilot --rosdistro melodic` on `Sun, 31 Mar 2019 06:17:36 -0000`
...
## rospilot (melodic) - 1.5.5-0

The packages in the `rospilot` repository were released into the `melodic` distro by running `/usr/bin/bloom-release rospilot --rosdistro melodic` on `Sat, 30 Mar 2019 04:16:16 -0000`
...
## rospilot (melodic) - 1.5.4-0

The packages in the `rospilot` repository were released into the `melodic` distro by running `/usr/bin/bloom-release rospilot --rosdistro melodic` on `Sun, 17 Feb 2019 23:31:03 -0000`
...
## rospilot (melodic) - 1.5.2-0

The packages in the `rospilot` repository were released into the `melodic` distro by running `/usr/bin/bloom-release rospilot --rosdistro melodic` on `Sat, 22 Sep 2018 16:44:19 -0000`
...
## rospilot (melodic) - 1.5.1-0

The packages in the `rospilot` repository were released into the `melodic` distro by running `/usr/bin/bloom-release rospilot --rosdistro melodic` on `Mon, 03 Sep 2018 19:53:45 -0000`
...
The packages in the `rospilot` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release rospilot --track kinetic --rosdistro kinetic` on `Wed, 08 Mar 2017 22:39:08 -0000`
